#!/bin/bash
# filepath: /home/lambda/code_projects/digital_engineering/visualcomputing_2025/vc_ss25_projekt6_ar_sports/start-server.sh
...
xdg-open "https://puliczek.github.io/ngrokqr/?url=$url"
